...
resource "aws_service_discovery_service" "eczane-service" {
  name = "eczane-service"
...
resource "aws_ecs_service" "eczane-service" {
  ...
  service_registries {
    registry_arn   = aws_service_discovery_service.eczane-service.arn
...
resource "aws_wafv2_web_acl_association" "eczane-alb" {
  resource_arn = aws_lb.eczane-alb.arn
